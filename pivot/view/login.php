                    ...
                    <div id="contents" class="container login">
						<?php if(isset($errorMessage)){
							...
							<form id="login" class="form-signin" action="<?php echo $thisSite; ?>login" method="post" role="form">
								...
								<input type="text" name="username" id="username" placeholder="Username" class="form-control" value="<?php if(isset($_POST[					'username'])){echo $_POST['username'];}?>">
								...
								<a href="createaccount">Create a new account</a><span class="inline-separator">|</span><a href="forgotpassword">Forgot my password</a>
